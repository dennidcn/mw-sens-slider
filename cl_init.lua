...
CreateClientConVar("mgbase_sensitivity_10x", "1", true, false, "10x magnification sensitivity multiplier.", 0.1, 5)
CreateClientConVar("mgbase_sensitivity_20x", "1", true, false, "20x magnification sensitivity multiplier.", 0.1, 5)
