...
hook.Add("PopulateToolMenu", "CustomMenuSettings", function()
	...
	spawnmenu.AddToolMenuOption("Options", "mw_options", "mw_sensitivity", MWBLTL.Get("SpawnMenu_Sens_Title"), "", "", function(panel)
		...
		panel:NumSlider(MWBLTL.Get("SpawnMenu_Sens_Text_10x"), "mgbase_sensitivity_10x", 0.1, 5, 2) 
		panel:ControlHelp(MWBLTL.Get("SpawnMenu_Sens_Help_10x")) 
		
		panel:NumSlider(MWBLTL.Get("SpawnMenu_Sens_Text_20x"), "mgbase_sensitivity_20x", 0.1, 5, 2) 
